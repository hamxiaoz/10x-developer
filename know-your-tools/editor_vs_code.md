...
* Custom snippets: [https://code.visualstudio.com/docs/customization/userdefinedsnippets](https://code.visualstudio.com/docs/customization/userdefinedsnippets)
* HTML with Emmet: [http://code.visualstudio.com/docs/languages/html\#\_emmet-snippets](http://code.visualstudio.com/docs/languages/html#_emmet-snippets)
...
[https://medium.com/@hamxiaoz/visual-studio-code-formatting-setup-9f40a95699ce](https://medium.com/@hamxiaoz/visual-studio-code-formatting-setup-9f40a95699ce)
...
![](../.gitbook/assets/vscode-open-folder-from-toolbar.gif) Go to my repo [open-folder-with-vs-code](https://github.com/hamxiaoz/open-folder-with-vs-code) and follow the instructions.
